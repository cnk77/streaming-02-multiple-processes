...
input_file = open("netflix_titles.csv","r")
...
for row in reader:
    ...
    showid, type, title, director, cast, country, date_added, release_year, rating, duration, listed_in, description = row

    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{showid}, {type}, {title}, {director}, {cast}, {country}, {date_added}, {release_year}, {rating}, {duration}, {listed_in}, {description}]"
